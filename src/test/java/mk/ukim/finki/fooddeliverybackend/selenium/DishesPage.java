...
public class DishesPage extends AbstractPage {
    ...
    public void setAddButton(List<WebElement> addButton) {
    ...
    public void setEditButtons(List<WebElement> editButtons) {
    ...
    public void setDeleteButtons(List<WebElement> deleteButtons) {
